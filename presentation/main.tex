...
% ---------------------------------------------------------------------------------
\عنوان{تازدگی اطلاعات در شبکه‌های \متن‌لاتین{LoRa}}
...
\begin{persian}
	...
	\شروع{فقرات}
	\فقره مدیریت دسترسی همزمان به واسطه الگوریتم \متن‌لاتین{Slotted ALOHA}
	\فقره $k$ حسگر
	\فقره $n$ بازه‌ی زمانی که اشیا در ابتدای هر بازه برای ارسال یا عدم ارسال اطلاعات تصمیم می‌گیرند.
	\فقره تخصیص فاکتورهای گسترش و زیرکانال‌های عمود برهم به اشیا برای جلوگیری از تصادم
	\پایان{فقرات}
	\end{frame}
