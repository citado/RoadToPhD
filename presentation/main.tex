...
\begin{persian}
	...
	\فقره هدف کمینه‌سازی هزینه با در نظر گرفتن محدودیت‌های کیفیت سرویس
	\فقره تاخیر به عنوان یکی از مهم‌ترین معیارهای کیفیت سرویس و تقسیم بار میان دروازه‌ها
	\پایان{فقرات}
	\end{frame}
