...
\begin{persian}
	...
	\begin{frame}[allowframebreaks]{}
		\begin{table}[h]
			...
			\begin{tabularx}{\textwidth}{XXXXXXXXXXXp{1cm}}
				\toprule
				مرجع &
				تحرک &
				\متن‌لاتین{coverage} &
				...
				تاخیر &
				محیط &
				استفاده از \متن‌لاتین{Mesh LoRaWAN} &
				شبیه‌سازی \\
				\midrule
	...
	\begin{frame}
		...
		\فقره استفاده از الگوریتم‌های نوبت‌دهی متفاوت از \متن‌لاتین{unslotted ALOHA} مانند \مرجع{Le2021}
