...
\begin{persian}
	...
	% -------------------------------------------------------------------------------
	\section{شبکه‌های \متن‌لاتین{LoRaWAN}}
	...
	\begin{frame}
	  \شروع{فقرات}
	  \فقره شبیه‌سازی مدل ساده شده از ارزیابی شبکه دسترسی \متن‌لاتین{LoRaWAN} از دروازه تا سرور شبکه و سرور اپلیکیشن
